...
5.refreshContext方法会调用父类的refresh方法，里面会调用到invokeBeanFactoryPostProcessor方法，然后再调用invokeBeanDefinationPostProcessor方法，在这个方法里，会取出ConfigureClassPostProcessor对当前应用的主类进行解析
